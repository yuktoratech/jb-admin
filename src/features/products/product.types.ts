...
export interface CreateSkuInput { size: string; status?: CatalogStatus; }
export interface CreateProductColourInput { colourId: string; status?: CatalogStatus; skus: CreateSkuInput[]; }
...
export interface CreateVariantPayload { productColourId: string; size: string; status?: CatalogStatus; }
export interface UpdateVariantPayload { status: CatalogStatus; }
export interface ProductColourPayload { productId: string; colourId: string; status?: CatalogStatus; }
...
export interface ProductImportRow { rowNumber: number; productName?: string; categoryName?: string; subCategoryName?: string; fitName?: string; fabricName?: string; description?: string; mrpPerPieceMinor?: number | null; colourName?: string; productCode?: string; expectedProductCode?: string; sizeSetLabel?: string; expectedSku?: string; suppliedSku?: string; status?: CatalogStatus; validationStatus?: "VALID" | "INVALID"; }
